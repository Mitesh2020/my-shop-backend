...
import img1 from "@/public/product.jpg";
              ...
              {productsToDisplay.map((product, index) => (
                <tbody className="divide-y divide-gray-200" key={product._id}>
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900 flex items-center  gap-3">
                      <div class="h-10 w-10 mb-3 ">
                        <img
                          class="mt-1 h-full w-full rounded-full object-cover object-center bg-gray-200"
